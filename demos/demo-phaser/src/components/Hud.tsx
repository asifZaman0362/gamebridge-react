...
import { playerStatsToApp, type PlayerStatsSnapshot } from "../phaser/PlayerStatsBridge";
import { GAME_WIDTH } from "../phaser/main";

const INITIAL_STATS: PlayerStatsSnapshot = { health: 100, score: 0, steps: 0 };

/** Overlays the player's live stats on top of the Phaser canvas, fed entirely over the bridge. */
